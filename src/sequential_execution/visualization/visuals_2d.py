...
from benchmark_functions import max_spherical_function, min_spherical_function, min_rastringin_function
...
if __name__ == "__main__":
    try:
        ...
        filepath = "../evolution_logs/min_rastringin_2d_log.json"
