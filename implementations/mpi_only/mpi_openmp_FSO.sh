...
readonly C_PROGRAM_PATH=~/hpc_project/implementations/mpi_only/mpi_openmp_FSO.c
readonly EXECUTABLE_PATH_AND_NAME=~/hpc_project/implementations/mpi_only/mpi_openmp_FSO
...
mpirun.actual -n 2 $EXECUTABLE_PATH_AND_NAME 8000 1000 200 1 scatter
