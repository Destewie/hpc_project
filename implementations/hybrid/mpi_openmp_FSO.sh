...
readonly C_PROGRAM_PATH=~/hpc_project/implementations/hybrid/mpi_openmp_FSO.c
readonly EXECUTABLE_PATH_AND_NAME=~/hpc_project/implementations/hybrid/mpi_openmp_FSO
...
mpirun.actual -n 2 $EXECUTABLE_PATH_AND_NAME 16000 1000 200 1 scatter
